...
const styles = StyleSheet.create({
  ...
  leagueTabs: { height: 52, flexGrow: 0, flexShrink: 0 },
  leagueTab: { paddingHorizontal: 14, justifyContent: 'center', alignItems: 'center', height: 34, borderRadius: 20, backgroundColor: COLORS.bgCard, borderWidth: 1, borderColor: COLORS.border },
